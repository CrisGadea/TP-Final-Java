...
<div class="container">
    <div class="row align-items-start">
            ...
            <div class="containerForm col-lg-6">
                ...
                <form:form action="crear-pelicula" method="POST" modelAttribute="pelicula" enctype="multipart/form-data">
                    <h2 >Agregar pelicula</h2>
                        ...
                        <div class="form-group">
                            <label for="portada">Cargar imagen de la portada</label>
            ...
            <div class="containerPresentacion col-lg-6">
                <div class="divImagen">
                    <img src="image/portada.jpg" alt="Portada" id="portadaPresentacion">
                </div>
                <div>
                    <h3 id="tituloPresentacion" class="letraAmarilla"></h3>
                    <p>Fecha de estreno: <span  id="fecha-estrenoPresentacion"></span></p>
                    <p>Genero: <span id="generoPresentacion"></span></p>
                    <p>Sinopsis:
                        <br />
                        <span  id="descripcionPresentacion"></span>
                    </p>
                </div>
            </div>
        </div>
